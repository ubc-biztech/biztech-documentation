...
{% callout type="warning" title="No gateway authentication" %}
These endpoints have no Cognito authorizer in `serverless.yml`. They are accessible to anyone who knows the URL. The endpoints rely on obscurity rather than authentication.
{% /callout %}
