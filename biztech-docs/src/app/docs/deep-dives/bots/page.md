...
### Feature 1: BizWiki (Documentation QA)

When someone asks a question in the BizWiki Slack channel, the bot searches the BizTech documentation and answers using AI.

**How it works:**

1. User posts a message in the designated Slack channel
