...
// emailCheck(userID) is called to verify the scanned ID looks like a valid email

// 3. Check if it's for the correct event
...
// 6. All checks passed, proceed with check-in!
```
